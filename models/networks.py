...
from models.ChangeFormer import ChangeFormerV1, ChangeFormerV2, ChangeFormerV3, ChangeFormerV4, ChangeFormerV5, ChangeFormerV6, LocalChangeFormer
...
def init_net(net, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    """
    if torch.cuda.is_available() & len(gpu_ids) > 0:
...
def define_G(args, init_type='normal', init_gain=0.02, gpu_ids=[]):
    ...
    elif args.net_G == 'LocalChangeFormer':
        net = LocalChangeFormer(embed_dim=args.embed_dim) #ChangeFormer with Transformer Encoder and Convolutional Decoder (Fuse)
